...
## What is Cloud Computing ? (computing on cloud)
...
**Hybrid Cloud:** Using both your private space and the shared online space when needed. Combination of both public and private cloud. For eg. banks deploy database on-premises(private) & host app on public cloud.

**Multi Cloud:** For eg. using some services of AWS and Azure.

### On-premises (private):

- `24 x 7` power supply
- overheads for system admins
- maintainance
- cost

### AWS (public): Data Center -> collection of servers

### private cloud users: banking & financial company.
